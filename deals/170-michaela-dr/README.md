...
The three HTML files are self-contained 16:9 slide decks (dark luxury identity, custom SVG charts on
most slides). Open in any browser — arrow keys / Page Up-Down navigate; print with backgrounds on for
slides. Matching one-slide-per-page PDFs are in `pdf/`.
